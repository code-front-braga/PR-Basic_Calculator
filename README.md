...
<img src='./src/assets/images/calculator_print.png' alt='Print do Projeto' />

## Sobre o Projeto:

Este projeto é uma calculadora simples, capaz de realizar as operações matemáticas básicas, incluindo:
...
```bash
git clone https://github.com/code-front-braga/PR-Basic_Calculator.git
```
...
Isso abrirá o projeto no seu navegador padrão. Ou se quiser ver somente o funcional, eu hospedei o projeto no GitHub Pages: [Calculator](https://code-front-braga.github.io/PR-Basic_Calculator/)
...
- Adicionar suporte para operações matemáticas avançadas.
- Melhorar a interface gráfica para tornar a calculadora mais intuitiva e responsiva.
